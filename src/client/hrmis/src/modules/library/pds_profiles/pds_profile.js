...
const PdsProfileMainView = (props) => {
    ...
    return (
        <div className="pds-profile-main-view">
            {formState === 1 && <FormFunctionStateOne />}
            {formState === 2 && <h1>WELCOME VIEW 211</h1>}
            {formState === 3 && <h1>WELCOME VIEW 212</h1>}
            {formState === 4 && <h1>WELCOME VIEW 213</h1>}
            <br/><br/>
            <div className="pds-profile-button-selection">
                ...
                <div className="margin-right-1"><ButtonComponent buttonName = "Save"/></div>
                
                {formState < 4 && <div className="margin-right-1"> 
                    <ButtonComponent
...
function FormFunctionStateOne (props) {
...
export default PdsProfileMainView;