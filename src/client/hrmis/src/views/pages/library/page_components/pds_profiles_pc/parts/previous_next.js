        ...
        <React.Fragment>
            <div className="success-email-confirm">
                ...
                */}
                ...
                <div className="header-confirmation">
                    <p>
                        We sent a message to your email address: <strong> { email } </strong> <br/>
                        The confirmation email was sent from: recruitment@dost.gov.ph <br/><br/>
                        
                        To complete your application, follow the link in the said email within 7 days. 
                        Application expires after 7 days if not verified and will be deleted, so you'll need to
                        apply again. <br/><br/>

                        You should recieve a verification email within 20 minutes after submission. If 
                        you're not seeing it in your inbox, check out your Spam or Junk folder.<br/><br/>

                        If you didn't get our email or having trouble verifying your email account, please 
                        contact us at recruitment@dost.gov.ph with approriate subject line and make sure to 
                        describe things exactly as they appear on your screen.<br/><br/>
