...
const EmployeePageComponentView = () => {
    ...
    const patternTabOne = <React.Fragment>
                            ...
                            <span className="margin-left-1 selector-span-1">
                                <select defaultValue={'DEFAULT'} >
                                    ...
                                    {employeeSelectFilter.map((item, key)=> {
                                        return <option className="options" key={key} value={item.value}>{item.title}</option>
                                    })}
                                </select>
                            </span>
                        </div>
                ...
                <div className="plantilla-table">
                                        ...
                                        return <tr className="trClass" key={key}>
                                            ...
                                            <td className = "column-option">
                                                <div className="inline-div-td-1">
                                                    {data.status}<br/>{data.status.score}
                                                </div>
                    ...
                    <p className="data-entry">Total of {employeeTableData.length} Entries</p>
                </div>                    
    </React.Fragment>
