...
const RecruitmentView = (props) => {
    ...
    return (
        ...
        <div className="tab-button">
            <button onClick={()=>toggleTab(1)} className={ (toggleState === 1)? "tab-tap tab-tap-activate" : "tab-tap"}>Qualified</button><BadgeComponent className="tab-badge-add-style" value={'1'}/>
