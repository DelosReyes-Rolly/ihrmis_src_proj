...
const JvsFormOne = () => {
  ...
  const jvsVersionOnChange = (value) => {
    itemJvsVersions.forEach((element) => {
      if (parseInt(value) === parseInt(element.jvs_version)) {
  ...
  if (version[0] === null || version[0] === undefined) {
    return (
      <React.Fragment>
        <div
          style={{
        ...
        >
          <div style={{ fontWeight: "bold" }}>
            Looks like there are no current Version of JVSCRW
          </div>
          <div>
            <ButtonComponent
              buttonName="Create JVSCRW"
