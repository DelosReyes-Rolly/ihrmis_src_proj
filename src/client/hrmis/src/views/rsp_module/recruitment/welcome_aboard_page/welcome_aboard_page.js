      ...
      <div className="aboard_holder">
        <div className="aboard_page_container">
          ...
          <div className="body-container" style={{ marginTop: "30px" }}>
            <div>
              ...
              <p>
                On behalf of all employees and the management, we would like to
              ...
              <br />
              <p>
                For a start, we encourage you to familiarize yourself with our
        ...
        <div className="footer-aboard-container">
          <div>
            ...
            quality and reliability within our capabilities and resources,
            according to customer and all applicable regulatory and statutory
            requirements, and continually improve the effectiveness of our
            Quality Management System (QMS) in order to meet customer
            satisfaction and organizational fullfillment"
          </div>
        </div>
      </div>
    </React.Fragment>
