...
const LibraryView = () => {
  ...
  //METHODS
  const addArrayDataState = () => {
    // For adding new education data
    setArrayDataState([
      ...arrayDataState,
      {
  ...
  const deleteArrayDataState = (e) => {
    // For Deleting education data
    ...
    <div style={{ margin: "20px" }}>
      ...
      <div className="for-position-modal">
        <ModalComponent
          ...
          title={"Position"}
        >
          {_displayTitleEligibilitySection()}
          <br />

          {_displayEducationSection({
            //METHOD'S PARAMETERS;
            arrayDataState,
            intSelectState,
            strCourseState, // STATES
            addArrayDataState,
            deleteArrayDataState, //METHOD ADD AND DELETE
            setIntSelectState,
            setStrCourseState, //METHOD FOR UPDATING STATE
          })}
          <br />

          {_displayExperienceSection()}
          <br />
...
function _displayEducationSection({
  ...
  return (
    <div className="position-modal-container-2">
      ...
      <div
        className="position-modal-container-1"
      ...
      >
        <div>
          ...
          {arrayDataState === null
            ? null
            : _displayAddedItems(arrayDataState, deleteArrayDataState)}
          ...
          >
            ...
            >
              <AiOutlinePlusCircle
                onClick={addArrayDataState}
                className="pmc-hover-over-icon-plus"
                size="23px"
              />
            </div>
          </div>
...
function _displayAddedItems(passItem, deleteLine) {
  return passItem.map((item, index) => {
    return (
      <div
        className="position-modal-container-1"
        style={{ marginTop: "0px" }}
      ...
      >
        ...
        >
          <AiOutlineMinusCircle
            ...
            className="pmc-hover-over-icon-minus"
            size="23px"
          />
        </div>
      </div>
