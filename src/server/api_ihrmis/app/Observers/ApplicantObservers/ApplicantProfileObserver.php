...
class ApplicantProfileObserver
{
     ...
     * @return void
     */
    // public function created(Tblapplicants $tblapplicantsProfile)
    // {
    //     $fullnameArray = [];
    //     $APPLICANT_TOKEN = Str::random(64);
    //     $applicant = new Tblapplicants();
    //     $applicant->app_id = $tblapplicantsProfile->app_id;
    //     $applicant->app_itm_id = $tblapplicantsProfile->position;
    //     $applicant->save();

    //     $createVerification = new TblapplicantVerification();
    //     $createVerification->vry_app_id = $tblapplicantsProfile->app_id;
