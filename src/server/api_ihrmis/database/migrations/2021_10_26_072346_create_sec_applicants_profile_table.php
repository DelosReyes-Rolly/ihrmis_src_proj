...
class CreateSecApplicantsProfileTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('mysql2')->create('sec_applicants_profile', function (Blueprint $table) {
...
number in its current agency.');
    ...
    {
        Schema::connection('mysql2')->drop('sec_applicants_profile', function (Blueprint $table) {
