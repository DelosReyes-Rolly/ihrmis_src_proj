...
class CreateTbljvsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbljvs', function (Blueprint $table) {
            ...
            $table->string('jvs_approved')->comment('Name of the person who approved the form, the date he/she signed  and the signature file if opted to be saved, in the format "<name>|<date>|<filename>".');
