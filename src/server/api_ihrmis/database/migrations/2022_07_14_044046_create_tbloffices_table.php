...
class CreateTblofficesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbloffices', function (Blueprint $table) {
            ...
            $table->integer('ofc_agn_id')->nullable()->comment('Agency identifier');
            ...
            $table->string('ofc_email_addr')->comment('Email address of office');
            ...
            $table->unsignedInteger('ofc_ofc_id')->nullable()->comment('Parent office ID.');
        });
    }
