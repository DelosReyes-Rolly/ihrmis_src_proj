...
class CreateTblofficesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbloffices', function (Blueprint $table) {
            ...
            $table->char('ofc_type', 1)->comment('Type or category of office. (1-DOST CO, 2-DOST RO/PSTC, 3-DOST Attached Agency, 4-Constitutional Bodies, 5-NGA, 6-GOCC, 7-LGU, 8-SUC, 9-PUC, 10-NGO, 11-Private Agency, 12-Others)');
